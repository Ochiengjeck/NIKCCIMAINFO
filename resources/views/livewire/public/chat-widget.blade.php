<div x-data="{ open: @entangle('open') }">
    ...
    <div
        ...
        class="fixed bottom-24 right-6 z-50 flex w-80 flex-col overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-2xl dark:border-zinc-700 dark:bg-zinc-900 sm:w-96"
        ...
        <div class="flex-1 space-y-3 overflow-y-auto px-4 py-4"
            ...
            <div wire:loading wire:target="send" class="flex justify-start">
                <div class="rounded-2xl rounded-bl-sm bg-zinc-100 px-4 py-3 dark:bg-zinc-800">
                    <span class="flex items-center gap-1">
                        <span class="h-2 w-2 animate-bounce rounded-full bg-zinc-400 dark:bg-zinc-500" style="animation-delay:0ms"></span>
                        <span class="h-2 w-2 animate-bounce rounded-full bg-zinc-400 dark:bg-zinc-500" style="animation-delay:150ms"></span>
                        <span class="h-2 w-2 animate-bounce rounded-full bg-zinc-400 dark:bg-zinc-500" style="animation-delay:300ms"></span>
                    </span>
                </div>
            </div>
        </div>
        ...
        <div class="border-t border-zinc-100 px-3 py-3 dark:border-zinc-800">
            <div class="flex items-center gap-2">
                <input wire:model="input"
                    ...
                    class="flex-1 rounded-xl border border-zinc-300 bg-zinc-50 px-4 py-2.5 text-sm text-zinc-900 placeholder:text-zinc-400 focus:border-green-500 focus:bg-white focus:outline-none focus:ring-2 focus:ring-green-500/20 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-100 dark:placeholder:text-zinc-500">
