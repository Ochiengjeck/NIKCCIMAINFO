            ...
            @else
                <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
                    @foreach($briefs as $brief)
                        <div class="group rounded-2xl border border-zinc-200 bg-white p-6 transition hover:border-brand-300 hover:shadow-md">
                                ...
                                <tr class="transition hover:bg-zinc-50">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <p class="text-sm font-medium text-zinc-900">{{ $doc->alt_text ?? $doc->original_filename }}</p>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
