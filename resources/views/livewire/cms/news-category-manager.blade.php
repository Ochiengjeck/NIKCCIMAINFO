<div>
    <div class="mb-6 flex items-center justify-between">
        <div>
            ...
            <flux:subheading>Organise articles into categories</flux:subheading>
        </div>
        <div class="flex items-center gap-2">
            <flux:button :href="route('admin.cms.news')" wire:navigate variant="ghost" icon="arrow-left">Back to Articles</flux:button>
            @can('cms.edit')
        ...
        <table class="min-w-full divide-y divide-zinc-200 dark:divide-zinc-700">
            <thead class="bg-zinc-50 dark:bg-zinc-800">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left text-xs font-medium uppercase tracking-wide text-zinc-500">Articles</th>
                        ...
                        <td class="px-4 py-3 text-right">
                            <div class="flex justify-end gap-2">
                                @can('cms.edit')
                                    ...
                                    <flux:button wire:click="delete({{ $category->id }})" wire:confirm="Delete this category? Its articles become uncategorised." size="sm" variant="ghost" icon="trash" class="text-red-500" />
                                @endcan
                            </div>
                        </td>
                    </tr>
