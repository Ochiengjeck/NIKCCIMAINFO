<div>
    <div class="mb-6 flex items-center justify-between">
        <div>
            <flux:heading size="xl">News &amp; Press Releases</flux:heading>
            <flux:subheading>Manage public news and announcements</flux:subheading>
        </div>
        @can('cms.edit')
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <flux:field>
                            ...
                            <flux:select wire:model="category">
                                ...
                                <flux:select.option value="press-release">Press Release</flux:select.option>
