<x-layouts::website :title="($event->title).' — NiKCCIMA Events'">
    ...
    <section class="relative overflow-hidden py-20 text-white lg:py-24">
        ...
        <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            {{-- Breadcrumb --}}
            <nav class="mb-6 flex items-center gap-2 text-sm text-[#922529]" aria-label="Breadcrumb">
                ...
                <span class="text-[#922529]">{{ Str::limit($event->title, 60) }}</span>
            </nav>
            ...
            <span class="mb-4 inline-flex rounded-full px-3 py-1 text-xs font-semibold text-white
                {{ $isFlagship ? 'bg-[#922529]/90' : 'bg-[#922529]/90' }}">
                ...
                <div class="lg:col-span-2">
                    ...
                    <div class="mt-10 border-t border-zinc-100 pt-6">
                        <a href="{{ route('events.index') }}"
                           class="inline-flex items-center gap-2 text-sm font-medium text-[#922529] transition hover:text-[#922529]">
                    ...
                    <div class="sticky top-24 rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm">
                        ...
                        <ul class="space-y-4">
                            ...
                            <li class="flex items-start gap-3">
                                <div class="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-[#A8DCAB]/20">
                                    <svg class="h-4 w-4 text-[#922529]" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        ...
                        <div class="mt-6 border-t border-zinc-100 pt-5">
                            <a href="{{ route('contact') }}?subject=Event+Inquiry%3A+{{ urlencode($event->title) }}"
                               class="flex w-full items-center justify-center gap-2 rounded-xl bg-[#922529] px-5 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-[#922529] hover:shadow-md">
