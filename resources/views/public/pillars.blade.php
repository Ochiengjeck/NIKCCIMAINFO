...
<x-layouts::website :title="($page?->section('page_heading', 'Our Four Pillars')).' — NiKCCIMA'">
    ...
    <section class="relative overflow-hidden py-24 text-white">
        ...
        @else
            ...
            <div class="pointer-events-none absolute -bottom-24 -left-16 h-80 w-80 rounded-full bg-brand-600/10 blur-3xl"></div>
        @endif

        <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <span class="mb-4 inline-flex rounded-full bg-crimson-700 px-4 py-1.5 text-xs font-semibold uppercase tracking-widest text-white">Structure</span>
            ...
            @if($pageSubtitle)
                <p class="mt-4 max-w-2xl text-brand-200 text-lg">{{ $pageSubtitle }}</p>
            @endif
        </div>
    </section>
    ...
    <section class="py-20 bg-zinc-50 dark:bg-zinc-950">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-14 text-center">
                <span class="text-xs font-semibold uppercase tracking-widest text-brand-600 dark:text-brand-400">Governance</span>
            ...
            <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
                ...
                <a href="{{ route('pillars.show', 'executive') }}"
                   class="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-brand-900 to-brand-800 p-8 text-white hover:-translate-y-1 hover:shadow-2xl transition-all duration-300">
                    ...
                    <p class="mb-2 text-xs font-semibold uppercase tracking-widest text-brand-200">Pillar 1</p>
                    ...
                    <p class="text-sm text-brand-200 leading-relaxed mb-6 line-clamp-4">
                    ...
                    <span class="inline-flex items-center gap-1.5 text-sm font-semibold text-brand-200 group-hover:text-white transition-colors duration-200">
                        Explore Pillar
                ...
                <a href="{{ route('pillars.show', 'trade') }}"
                   class="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-brand-800 to-brand-700 p-8 text-white hover:-translate-y-1 hover:shadow-2xl transition-all duration-300">
                    <div class="mb-6 flex h-12 w-12 items-center justify-center rounded-xl bg-white/15 group-hover:bg-white/25 transition-colors duration-200">
                        {{-- Trending up icon --}}
                        <svg class="h-6 w-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    ...
                    <p class="mb-2 text-xs font-semibold uppercase tracking-widest text-brand-200">Pillar 2</p>
                    <h3 class="font-serif text-xl font-bold text-white mb-3 leading-snug">
                        {{ $page?->section('pillar2_title', 'Trade & Investment Facilitation') }}
                    </h3>
                    <p class="text-sm text-brand-100 leading-relaxed mb-6 line-clamp-4">
                ...
                <a href="{{ route('pillars.show', 'policy') }}"
                   class="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-brand-800 to-brand-700 p-8 text-white hover:-translate-y-1 hover:shadow-2xl transition-all duration-300">
                    ...
                    <p class="mb-2 text-xs font-semibold uppercase tracking-widest text-brand-200">Pillar 3</p>
                    <h3 class="font-serif text-xl font-bold text-white mb-3 leading-snug">
                ...
                <a href="{{ route('pillars.show', 'admin') }}"
                   class="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-brand-800 to-brand-900 p-8 text-white hover:-translate-y-1 hover:shadow-2xl transition-all duration-300">
                    <div class="mb-6 flex h-12 w-12 items-center justify-center rounded-xl bg-white/15 group-hover:bg-white/25 transition-colors duration-200">
                        {{-- Cog icon --}}
                        <svg class="h-6 w-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    ...
                    <p class="mb-2 text-xs font-semibold uppercase tracking-widest text-brand-200">Pillar 4</p>
                    <h3 class="font-serif text-xl font-bold text-white mb-3 leading-snug">
    ...
    <section class="bg-zinc-900 dark:bg-zinc-950 py-16 border-t border-zinc-800">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
            ...
            <a href="{{ route('trade') }}"
               class="inline-flex items-center gap-2 rounded-full bg-brand-600 px-8 py-3.5 text-sm font-semibold text-white shadow-sm hover:bg-brand-400 transition-colors duration-200">
                Go to Trade Portal
