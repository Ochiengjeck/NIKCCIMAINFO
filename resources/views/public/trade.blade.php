<x-layouts::website :title="'Trade & Investment — NiKCCIMA'">
    ...
    <section class="bg-[#922529] py-16 text-white">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <span class="mb-3 inline-block text-xs font-semibold uppercase tracking-widest text-[#922529]">Portal</span>
            <h1 class="text-4xl font-bold">{{ $page?->section('hero_title', 'Trade & Investment Portal') }}</h1>
            <p class="mt-3 max-w-2xl text-[#922529]">{{ $page?->section('hero_subtitle', 'Connect with active trade opportunities and anchor investors across the Nigeria-Kenya AfCFTA corridor.') }}</p>
        </div>
    </section>
        ...
        <section class="py-14 bg-zinc-50">
            <div class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-6">
                    <span class="text-xs font-semibold uppercase tracking-widest text-[#922529]">Corridor</span>
    ...
    <section class="py-16">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="mb-8">
                <span class="mb-2 inline-block text-xs font-semibold uppercase tracking-widest text-[#922529]">Live</span>
                    ...
                    @foreach($leads as $lead)
                        <div class="rounded-xl border border-zinc-200 bg-white p-6">
                            <div class="mb-3 flex flex-wrap items-center gap-2">
                                <span class="inline-flex rounded-full bg-[#A8DCAB]/20 px-2.5 py-0.5 text-xs font-medium text-[#922529]">
                            ...
                            <a href="{{ route('contact') }}?subject={{ urlencode('Trade Inquiry: '.$lead->title) }}"
                                class="inline-flex items-center gap-1.5 rounded-lg border border-[#A8DCAB]/30 bg-[#A8DCAB]/20 px-3 py-1.5 text-xs font-medium text-[#922529] hover:bg-[#A8DCAB]/20">
                                Submit Inquiry &rarr;
                            </a>
                        </div>
                    @endforeach
    ...
    @if($investors->isNotEmpty())
        <section class="bg-zinc-50 py-16">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="mb-8">
                    <span class="mb-2 inline-block text-xs font-semibold uppercase tracking-widest text-[#922529]">Investment</span>
    ...
    @if($page?->section('export_resources_body'))
        <section class="py-16">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div class="mt-6">
                    <a href="{{ route('downloads') }}" class="inline-flex items-center gap-2 rounded-lg bg-[#922529] px-5 py-2.5 text-sm font-medium text-white hover:bg-[#922529]">
