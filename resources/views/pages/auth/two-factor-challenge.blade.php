        ...
        >
            ...
            <form method="POST" action="{{ route('two-factor.login.store') }}" class="space-y-4">
                ...
                <div class="space-y-5 text-center">
                    <div x-show="!showRecoveryInput">
                        <div class="my-5 flex items-center justify-center rounded-xl border border-slate-200 bg-slate-50 p-4">
                            <flux:otp
                                x-model="code"
                                length="6"
                                name="code"
                ...
                <div class="rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-center text-sm text-slate-600">
                    ...
                    <div class="inline cursor-pointer font-medium underline decoration-slate-300 underline-offset-4">
