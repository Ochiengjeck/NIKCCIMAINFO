...
class RolesAndPermissionsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $permissionGroups = [
            ...
            'policy' => ['view', 'create', 'edit', 'publish', 'delete'],
        ...
        $roles = [
            ...
            'global-governing-council' => [
                ...
                'policy.view', 'policy.edit', 'policy.publish', 'policy.delete',
                'events.view',
                'documents.view', 'documents.approve', 'documents.delete',
            ...
            'global-secretariat' => [
                ...
                'policy.view', 'policy.create', 'policy.edit', 'policy.publish', 'policy.delete',
